...
require '../ProfileModule/phpmailer/src/Exception.php';
require '../ProfileModule/phpmailer/src/PHPMailer.php'; 
require '../ProfileModule/phpmailer/src/SMTP.php'; 
...
if(isset($_POST['sendMSG'])) {
    ...
    try {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'FROM ZAMBALES LOCAL MARKET - DO NOT REPLY...     ' . '     From - Admin of ZAMBALES LOCAL MARKET     ';
        $mail->Body    = $message;

...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($_POST['email']) || empty($_POST['subject']) || empty($_POST['message'])) {
        ...
        // Update user status
        $user_status_updated = updateUserStatus($conn, $email, 'PENDING'); // Change status to "PENDING"
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title text-center mb-4">Payment Pending Approval</h3> <!-- Change title -->
                    <p class="card-text text-center">Your payment is pending approval. Please wait for the admin to review your payment.</p> <!-- Change text -->
                    <p class="card-text text-center">(You can try logging-in every 10 mins to check if your verify)</p>
                    <hr>
                    <h5 class="card-title text-center mb-3">Contact Admin</h5>
                    <form action="approval.php" method="post"> <!-- Change form action to stay on the same page -->
                        <div class="mb-3">

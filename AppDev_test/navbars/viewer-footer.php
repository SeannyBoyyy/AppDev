...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST['email']) || empty($_POST['subject']) || empty($_POST['message'])) {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            // Prepare and bind
            $stmt = $conn->prepare("INSERT INTO admin_messages (email, subject, message) VALUES (?, ?, ?)");
...
<div class="">
    ...
    <footer class="text-center text-lg-start text-dark" style="background-color: #ECEFF1">
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p><a href="#!" class="text-dark">Vegetable Products</a></p>
                        <p><a href="#!" class="text-dark">Fruit Products</a></p>
                        <p><a href="#!" class="text-dark">Meat Products</a></p>
                        <p><a href="#!" class="text-dark">Other Products</a></p>
                    </div>
                    <!-- Grid column -->
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2024 Copyright:
            <a class="text-dark" href="#!">Zambales Local Market</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->

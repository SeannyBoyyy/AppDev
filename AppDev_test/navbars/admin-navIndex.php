      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav justify-start">
              <li class="nav-item" style="font-size:12px;">
                <button class="btn" type="button" aria-current="page" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop" style="color:black;">
                  ...
                  <span style="color: black; font-size: 14px;">Admin Page</span>
                </button>
              </li>
        </ul>
      </div>
